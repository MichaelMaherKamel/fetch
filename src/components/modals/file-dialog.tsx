  ...
  return (
    <Dialog>
      ...
      <DialogContent className='sm:max-w-[480px]'>
        <p className='absolute left-5 top-4 text-base font-medium text-muted-foreground'>Upload your images</p>
        <div
          {...getRootProps()}
          className={cn(
        ...
        >
          ...
          {isUploading ? (
            <div className='group grid w-full place-items-center gap-1 sm:px-10'>
              <UploadIcon className='h-9 w-9 animate-pulse text-muted-foreground' aria-hidden='true' />
            </div>
          ) : isDragActive ? (
            <div className='grid place-items-center gap-2 text-muted-foreground sm:px-5'>
              <UploadIcon className={cn('h-8 w-8', isDragActive && 'animate-bounce')} aria-hidden='true' />
            ...
            <div className='grid place-items-center gap-1 sm:px-5'>
              ...
              <p className='text-sm text-slate-500'>Please upload file with size less than {formatBytes(maxSize)}</p>
            </div>
          )}
        </div>
        ...
        {files?.length ? (
          <Button type='button' variant='outline' size='sm' className='mt-2.5 w-full' onClick={() => setFiles(null)}>
      ...
      <div className='flex items-center gap-2'>
        {file.type.startsWith('image') && (
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
              <p className='absolute left-5 top-4 text-base font-medium text-muted-foreground'>Crop image</p>
